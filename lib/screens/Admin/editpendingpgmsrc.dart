...
class Editpendingpgmsrc extends StatefulWidget {
  String? name;
  String? address;
  String? loc;
  String? phn;
  ...
  @override
  _EditpendingpgmsrcState createState() => _EditpendingpgmsrcState();
}

class _EditpendingpgmsrcState extends State<Editpendingpgmsrc> {
  ...
  FirebaseFirestore fb = FirebaseFirestore.instance;
    ...
    CustomerPgmHistory custhistory = CustomerPgmHistory(
        upDate: upDate,
        upTime: upTime,
        msg: "Pending Program updated By Admin",
        status: "editted",
