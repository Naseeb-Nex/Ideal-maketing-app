...
class EditTechprofile extends StatefulWidget {
  ...
  @override
  _EditTechprofileState createState() => _EditTechprofileState();
}

class _EditTechprofileState extends State<EditTechprofile> {
      ...
      await firebaseFirestore
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return Simplealert(
                  titles: "Technician Profile Updation Completed!",
                  colorr: bluebg,
                  done: "Sucessfull",
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return Simplealert(
                  titles: "Something went Wrong, Try again!",
